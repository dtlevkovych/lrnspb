...
import com.dtlev.lrnspb.challenge.controller.ChallengeAttemptController;
...
class ChallengeAttemptControllerTest {
    ...
    void postValidResult() throws Exception {
        ...
        String requestBody = jsonRequestAttempt.write(attemptDTO).getJson();

        MockHttpServletResponse response =
                mvc.perform(post("/attempts")
